...
import { FundingNeedsTab } from "@/components/shelters/FundingNeedsTab";
		...
		<Page>
			<div>
				<TitleRow>
					...
					{/* apre l'area operativa: senza membership l'accesso è in
					    modalità PLATFORM_ADMIN (banner + audit) */}
					<OpenBoLink href={`/shelters/${id}/dashboard`}>
						Apri back office rifugio →
					</OpenBoLink>
				</TitleRow>
				<PageSub>
			...
			<Tabs
				entries={[
					...
					},
					{
						value: "funding-needs",
						label: "Traguardi",
						node: <FundingNeedsTab shelterId={id} />,
					},
				]}
			/>
		</Page>
